    ...
    <>
      ...
      <header className="sticky top-0 z-50 border-b border-gray-200 bg-white">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          {/* Mobile header row: hamburger | logo | Auctions */}
          <div className="flex h-14 items-center md:hidden">
            ...
            <Link
              href="/auctions"
              className="ml-auto text-sm font-semibold text-gray-700 hover:text-gray-900"
            >
              Auctions
            </Link>
          </div>
        ...
        <div className="fixed inset-0 z-[60] bg-white md:hidden">
          ...
          <div className="overflow-y-auto px-6 py-6">
            <nav className="space-y-1">
              <Link
                href="/auctions"
                className="block rounded-md px-3 py-3 text-lg font-semibold text-gray-900 hover:bg-gray-50"
                onClick={() => setMobileMenuOpen(false)}
              >
                Auctions
              </Link>
              ...
              <Link
                href="/dashboard/listings/new"
                className="block rounded-md px-3 py-3 text-lg font-semibold text-brand-600 hover:bg-brand-50"
                onClick={() => setMobileMenuOpen(false)}
              >
                Sell a Truck
              </Link>
              ...
              {session ? (
                <div className="space-y-1">
                  ...
                  <button
                    ...
                    className="block w-full rounded-md px-3 py-3 text-left text-lg font-semibold text-gray-900 hover:bg-gray-50"
                  >
                    Sign Out
                  </button>
                </div>
